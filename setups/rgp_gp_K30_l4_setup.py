...
# -*- coding: utf-8 -*-
"""
Setup with 30 arms and sqaured exponential kernel with l=4
for optimistic planning experiments
"""
...
# set the seed
np.random.seed(5389) # old seed 1239
...
class Arm:
    def __init__(self, samples, index, zinit, noisevar):
        ...
        self.res = 0.0
        self.model = None
        self.kernel = GPy.kern.RBF(input_dim=1, variance=1., lengthscale=4)
...
# sample the reward functions from a gp prior then fix them
kern = GPy.kern.RBF(input_dim=1, variance=1., lengthscale=4)
