...
# -*- coding: utf-8 -*-
"""
run the 1RGP-TS algorithm in various parametric settings
...
""" define constants and functions for algorithm """
...
meancumregRGPTS = np.mean(CUMREG, axis=0)
meancumrewRGPTS = np.mean(CUMREW, axis=0)
...
# save output
filenames = ['logistic_l25', 'logistic_l5', 'logistic_l75', 'gamma_l25', 'gamma_l5', 'gamma_l75']
myname = filenames[job-1]
np.savez('saves/rgpts_noinfl_%s' %myname, meancumregRGPTS=meancumregRGPTS, meancumrewRGPTS=meancumrewRGPTS, rep=rep,
